...
Instrucciones
1. En la carpeta ya creada, crea un nuevo archivo JavaScript (.js). Promedio alumnos graduados por curso
2. El Tech Leader, nos ¡Felicita! por los avances realizados en el desafío anterior. Dado que hemos mostrado bastante expertise, sube su exigencia y nos pide que ayudemos a uno de los equipos de desarrollo. Necesitan un código que permita determinar el promedio de alumnos egresados por curso. Para lograrlo debemos realizar lo siguiente:
...
c. Crear una función que reciba como parámetros los cuatro arrays de los alumnos graduados y un número comprendido entre el 1 y el 4, donde:
i. 1 = HTML5
ii. 2=CSS3
iii. 3 = JAVASCRIPT
iv. 4 = NODEJS
...
let javacript = "70 65 58 45 23 57 34 17 72";
let nodejs = "45 56 73 34 65 72 70 32";

let html5Array = html5.split(" ")
let css3Array = css3.split(" ")
let javascriptArray = javacript.split(" ")
let nodejsArray = nodejs.split(" ")

function calcularGraduados (html5Array, css3Array, javascriptArray, nodejsArray, curso){
    let graduados ;
    let nombreCurso ;
    ...
    let promedio = suma / graduados.length;
  return "El promedio de graduados en el curso de " + nombreCurso + " es: " + promedio;
}
calcularGraduados(html5Array,css3Array,javascriptArray,nodejsArray, 1)